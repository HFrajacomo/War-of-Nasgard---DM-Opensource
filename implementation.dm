...
#define BASE_MENU_CREATE_CHARACTER	"Criar Personagem"
#define BASE_MENU_DELETE_CHARACTER	"Deletar Personagem"
#define BASE_MENU_CANCEL			"Cancelar"
#define BASE_MENU_QUIT				"Sair"
...
mob/BaseCamp/ChoosingCharacter
	...
	proc/ChooseCharacterMenu(list/menu)
		...
		var/default = null
		var/result = input(src, "Menu","War of Nasgard", default) in menu
	...
	proc/DeleteCharacterMenu(list/menu)
		...
		var/default = null
		var/result = input(src, "Qual personagem você deseja deletar ?", "Deletando Personagem", default) in menu
		if (result)
